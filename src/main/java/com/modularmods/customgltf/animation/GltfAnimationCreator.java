...
public final class GltfAnimationCreator {
	...
	public static List<InterpolatedChannel> createGltfAnimation(AnimationModel animationModel) {
		...
		for(Channel channel : channels) {
			...
			{
				CustomGLTF.logger.warn("Input data is not an AccessorFloatData, but "
						+ inputData.getClass());
				continue;
			}
			...
			{
				CustomGLTF.logger.warn("Output data is not an AccessorFloatData, but "
						+ outputData.getClass());
				continue;
			}
			...
			case "translation":
				...
				case CUBICSPLINE:
					...
					break;
				default:
					CustomGLTF.logger.warn("Interpolation type not supported: " + interpolation);
					break;
				}
				break;
			case "rotation":
			...
			case "weights":
				...
				break;
			default:
				CustomGLTF.logger.warn("Animation channel target path must be "
